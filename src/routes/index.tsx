        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5">
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[1.05] text-foreground">
              Collector Cars,<br />Carefully Curated.
            </h1>
            <p className="mt-8 text-lg text-muted-foreground max-w-md">
              A quiet marketplace for rare, vintage and meaningful automobiles —
              connecting Pakistani collectors with cars worth keeping.
            </p>
            <div className="mt-10 flex flex-wrap gap-3">
              <LinkButton to="/cars">Browse Cars</LinkButton>
              <LinkButton to="/sell" variant="outline">List Your Car</LinkButton>
            </div>
          </div>
